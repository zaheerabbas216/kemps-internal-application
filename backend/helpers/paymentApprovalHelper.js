 ...
 * @param {number} [opts.creditAmount]  - Customer credit balance applied
 * @param {number} opts.amount         - Total amount (cash+UPI+bank only, excluding credit)
    ...
    await db.query(
      `INSERT INTO payment_approvals 
       (approval_id, transaction_id, source_module, transaction_type, reference_no, party_name, description,
        payment_method, cash_amount, upi_amount, bank_amount, credit_amount, amount, transaction_date, entered_by, remarks, 
      ...
      [
        ...
        parseFloat(opts.creditAmount) || 0,
