...
const Dashboard = () => {
  ...
  // ── Open add form pre-filled with user name ────────────────────────────────
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-3 xl:grid-cols-4 gap-2.5">
            {quickTiles.map(tile => (
              <button
                ...
                className={`${tile.bg} rounded-2xl p-3 flex flex-col items-start gap-1.5 hover:shadow-md border border-white hover:border-slate-200 transition-all text-left active:scale-95`}
              >
