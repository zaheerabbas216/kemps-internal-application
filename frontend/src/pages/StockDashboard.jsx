...
const StockDashboard = () => {
  ...
  const shortcuts = [
    {
      ...
      description: 'Assign urgent plant tasks, follow up on stock discrepancies, maintenance repairs, and track tasks to completion history.'
    },
    {
      title: 'Raw Material Ledger',
      tag: 'Live Stock & Consumption',
      ...
      description: 'Track daily live raw material inventory, purchases (Stock IN), production consumption (Stock OUT), and closing balances.'
    },
    {
      title: 'Goods Ledger',
      ...
      description: 'Monitor finished water bottles and jars stock, daily manufacturing additions, customer dispatches, and active warehouse inventory.'
    },
    {
      title: 'Maintenance Form',
      tag: 'Facility & Machinery Logs',
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {/* Top Header Card */}
      <div className="card-premium p-6 sm:p-8 relative overflow-hidden bg-gradient-to-r from-slate-900 via-[#111c38] to-[#1e293b] text-white">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-slate-400 text-xs font-semibold">Stock & Inventory Operations</span>
            </div>
            ...
            <p className="text-slate-300 text-xs sm:text-sm font-medium mt-1.5 max-w-xl leading-relaxed">
              Fast-track navigation for raw material stock, finished goods inventory, and facility maintenance logging.
            </p>
          </div>
