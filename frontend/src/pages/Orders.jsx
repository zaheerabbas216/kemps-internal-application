...
const Orders = () => {
  ...
  const handleTriggerEdit = () => {
    ...
    setOrderInfo({
      ...
      customerType: o.customer_type || 'General Customer',
      ...
      advanceAmount: String(o.advance_amount != null ? o.advance_amount : '0'),
      discount: String(o.discount != null ? o.discount : '0'),
      tax: String(o.tax != null ? o.tax : '0')
    });
    ...
    const mappedItems = (orderDetail.items || []).map(item => {
      ...
      const qtyVal = parseFloat(item.quantity || item.qty || 0);
    ...
    setFormItems(mappedItems.length > 0 ? mappedItems : [{ id: Math.random().toString(36).substring(2, 9), finishedProductId: '', quantity: '', rate: '', amount: 0 }]);
  ...
  const handleGenerateLoading = () => {
    if (!orderDetail) return;
    navigate('/loading', { state: { preloadOrder: orderDetail } });
  };
