    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {isFormModalOpen && (
        <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-0 bg-transparent pointer-events-none">
          <div className="bg-white rounded-3xl shadow-[0_25px_80px_rgba(0,0,0,0.2)] border border-slate-200 w-[650px] h-[550px] flex flex-col overflow-hidden animate-fade-in pointer-events-auto">
            {/* Header - Fixed at top */}
