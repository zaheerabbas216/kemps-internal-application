    ...
    <div className="space-y-6 animate-fade-in max-w-6xl mx-auto pb-12">
      ...
      <div className="card-premium space-y-4 no-print">
        <div className="text-[11px] font-black text-slate-450 uppercase tracking-widest border-b border-slate-100 pb-2">
          <span>🔍 CUSTOMER ACCOUNT SELECTOR</span>
        </div>
          ...
          {summary && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 no-print">
              ...
              <div className="card-premium flex items-center justify-between p-5 bg-white hover:scale-[1.02] transition-transform">
                <div>
                  <p className="text-[10px] font-black text-slate-450 uppercase tracking-widest">Monthly Sales</p>
              ...
              <div className="card-premium flex items-center justify-between p-5 bg-white hover:scale-[1.02] transition-transform">
                <div>
                  <p className="text-[10px] font-black text-slate-450 uppercase tracking-widest">Yearly Sales</p>
                  <h3 className="text-xl font-extrabold text-slate-850 mt-1.5">
                    ₹ {formatCurrency(summary.salesYear)}
                  </h3>
              ...
              <div className="card-premium flex items-center justify-between p-5 bg-white hover:scale-[1.02] transition-transform">
                <div>
                  <p className="text-[10px] font-black text-slate-455 uppercase tracking-widest">Payments Received</p>
                  <h3 className="text-xl font-extrabold text-emerald-600 mt-1.5">
                    ₹ {formatCurrency(summary.paymentsReceived)}
                  </h3>
                  <span className="text-[10px] text-slate-400 font-bold block mt-1">Total Credits Logged</span>
                </div>
              ...
              <div className="card-premium flex items-center justify-between p-5 bg-white hover:scale-[1.02] transition-transform">
                <div>
                  <p className="text-[10px] font-black text-slate-455 uppercase tracking-widest">Outstanding Due</p>
                  ...
                  <span className="text-[10px] text-slate-400 font-bold block mt-1">
                    Limit: <span className="font-extrabold text-slate-500">{summary.creditLimit}</span>
                  </span>
                </div>
            ...
            <div className="print-layout">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px', fontSize: '11px', fontWeight: '600' }}>
                ...
                <div style={{ border: '1px solid #ddd', padding: '12px', borderRadius: '6px' }}>
                  ...
                  <div style={{ display: 'flex', justifyValues: 'space-between', marginBottom: '3px' }}>
                    <span>Total Sales (Debits):</span>
                    <span style={{ marginLeft: 'auto', fontWeight: 'bold' }}>₹ {formatCurrency(transactions.reduce((acc, c) => acc + c.debit, 0))}</span>
                  </div>
                  <div style={{ display: 'flex', justifyValues: 'space-between', marginBottom: '3px' }}>
                    <span>Total Collections (Credits):</span>
                    <span style={{ marginLeft: 'auto', fontWeight: 'bold', color: 'green' }}>₹ {formatCurrency(transactions.reduce((acc, c) => acc + c.credit, 0))}</span>
                  </div>
